...
public class TestOrdersTransaction {
	...
	public static void main(String[] args) {
		...
		for (OrdersTransaction i : list) {
			System.out.println(i.getId() + "\t" + i.getOrderId().getId() + "\t" + i.getItemId().getId() + "\t"
					+ i.getQuantity() + "\t" + i.getTimeStamp() + "\t" + i.getStatus());
		}

		ordersTransaction = ordersTransactionDAO.listById(105);
		System.out.println(ordersTransaction.getId() + "\t" + ordersTransaction.getOrderId().getId() + "\t"
				+ ordersTransaction.getItemId().getId() + "\t" + ordersTransaction.getQuantity() + "\t"
				+ ordersTransaction.getTimeStamp() + "\t" + ordersTransaction.getStatus());
